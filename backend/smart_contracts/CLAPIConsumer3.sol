...
contract CLAPIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function setAuthorizedListers(address[] calldata addresses) public onlyOwner {
        authorizedListers = addresses;
    }

    function setAuthorizedPurchasers(address[] calldata addresses) public onlyOwner {
        authorizedPurchasers = addresses;
    }

    function removeAuthorizedListers(address[] calldata addresses) public onlyOwner {
    ...
    function removeAuthorizedPurchasers(address[] calldata addresses) public onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
